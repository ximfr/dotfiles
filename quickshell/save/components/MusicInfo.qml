...
Item {
        ...
        stdout: StdioCollector {
            onStreamFinished: {
                ...
                if (lines.length >= 5) {
                    ...
                    let pos_sec = pos > 100000 ? Math.round(pos / 1000000) : Math.round(pos);
                    let len_sec = len > 100000 ? Math.round(len / 1000000) : Math.round(len);
    ...
    Timer { id: coverDelay; interval: 300; repeat: false; onTriggered: { coverExtractor.running = true; } }
}